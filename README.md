...
* __Commit 14.4__ - реализовал показ статусов отправки данных формы модального окна заказа абонемента, сверстал и стилизовал блок показа статуса отправки данных. Отрефакторил код в файле <b style="background-color: #FF0000;">form.js</b>;